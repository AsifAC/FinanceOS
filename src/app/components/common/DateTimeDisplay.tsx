...
export function DateTimeDisplay({
  ...
  return (
    <div className={cn(
      "inline-flex min-w-0 items-center gap-3 rounded-[20px] border border-[var(--financeos-border)] bg-[var(--financeos-surface-elevated)] px-3 py-2 shadow-[var(--financeos-shadow-card)]",
      className,
    )}>
      <span className="financeos-settings-icon flex h-8 w-8 shrink-0 items-center justify-center rounded-2xl text-[#8B5CF6]">
      ...
      <span className="min-w-0">
        ...
        <span className="block truncate text-xs text-[var(--financeos-text-muted)]">
          {timezone} · {offset}
        </span>
      </span>
    </div>
