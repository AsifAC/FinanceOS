...
- Public authentication uses a fixed dark theme (`#030403` / `#050505`), off-white text, restrained borders and the FinanceOS lime accent (`#C6FF00`). It does not inherit the logged-in app's light/dark preference.
